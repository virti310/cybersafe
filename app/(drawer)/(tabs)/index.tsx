...
export default function HomeScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* Header Section */}
      <View style={[styles.header, { paddingHorizontal: 24, paddingTop: 16 }]}>
          ...
          {features.map((item) => (
            ...
            >
              <View style={styles.iconContainer}>
                <Image source={item.image} style={{ width: 120, height: 120, resizeMode: 'cover', borderRadius: 16, overflow: 'hidden' }} />
              </View>
