...
import { View, Text, StyleSheet, useWindowDimensions, ScrollView, NativeSyntheticEvent, NativeScrollEvent } from 'react-native';
...
export default function TextSlider({ data }: TextSliderProps) {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                {data.map((item, index) => (
                    <View key={item.id} style={[styles.slide, { backgroundColor: item.backgroundColor, width: width - 48 }]}>
